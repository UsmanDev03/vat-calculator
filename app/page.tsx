...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.freevatchecker.co.uk"),
  title: "UK VAT Calculator 2026 | Add or Remove VAT Instantly",
  description:
    "Free UK VAT calculator. Add or remove VAT at 20%, 5% or 0%, see net, VAT and gross amounts instantly, and check 2026 rates and the £90,000 threshold.",
  verification: {
    google: "AWvXQB3KfigZ8fZ2p6wOx9fPwevOCOSCn36CCnfGwxk",
  },
  openGraph: {
    title: "Free UK VAT Calculator 2026",
    description:
      "Add or remove VAT at 20%, 5%, 0% or any custom rate. Instant net, VAT and gross figures. No sign up, no data stored.",
    url: "https://www.freevatchecker.co.uk/",
    type: "website",
  },
  alternates: {
    canonical: "https://www.freevatchecker.co.uk/",
  },
};
...
export default function Home() {
  ...
  const webAppSchema = {
    ...
    url: "https://www.freevatchecker.co.uk/",
    description:
      "Free UK VAT calculator that adds or removes VAT at 20%, 5%, 0% or custom rates, showing net, VAT and gross amounts.",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground antialiased selection:bg-primary/20">
        ...
        <section
          id="calculator"
          className="py-16 md:py-24 px-4 bg-background border-b border-border/40"
        >
